...
func _capturas() -> void:
	...
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(6, 38))
	await _captura("luz_porton_oeste")
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(24, 29))
	await _captura("luz_calle_alta")
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(36, 49))
