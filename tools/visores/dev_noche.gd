...
func _capturas() -> void:
	...
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(6, 25))
	await _captura("luz_porton_oeste")
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(12, 16))
	await _captura("luz_calle_alta")
	_jugador.global_position = PuebloPlano.centro_px(Vector2i(24, 36))
