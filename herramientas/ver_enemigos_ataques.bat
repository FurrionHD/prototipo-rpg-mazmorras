...
if not exist "%GODOT%" (
    ...
    echo   %GODOT%
    echo Abre el proyecto en Godot, selecciona tools/visores/dev_enemigos_ataques.tscn y pulsa F6.
    pause
    exit /b 1
)
"%GODOT%" --path "%~dp0.." res://tools/visores/dev_enemigos_ataques.tscn
