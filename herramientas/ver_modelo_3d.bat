...
REM
REM ABRE UNA VENTANA GRIS a proposito (en --headless no se dibuja nada): NO ENSEÑA NADA, pinta por dentro
REM y se cierra sola. Las imagenes salen en tools\salida\modelo3d\, que se abre al terminar.
...
"%GODOT%" --path "%~dp0.." res://tools/visores/dev_modelo_3d.tscn -- %1
