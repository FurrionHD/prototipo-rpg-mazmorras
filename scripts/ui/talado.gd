...
func _draw() -> void:
	...
	MedidorFaena.marcas(self, w * 0.5, MedidorFaena.Y_MARCAS, _hachazos, _progreso, MedidorFaena.AZUL)
	MedidorFaena.marcas(self, w * 0.5, MedidorFaena.Y_MARCAS_2, ASTILLAS_ROTO, _astillas, MedidorFaena.ROJO)
