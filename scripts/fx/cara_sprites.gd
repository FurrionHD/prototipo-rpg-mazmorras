...
const SITIOS := {
	...
	# que queda a la derecha en SE) sube 2 px y el de delante se queda donde estaba -- se probo subirlo
	# tambien 1 px y lo descarto. SW sale solo, porque es el espejo de SE.
	1: {"ojo": Vector2(7.5, 5.0), "ojo_atras": Vector2(2.5, 8.5), "boca": Vector2(5.0, 10.5)},
