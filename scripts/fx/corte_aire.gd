...
# Un punto de la cuchilla puesta a 's' px: 'u' de lado a lado (-1..1), 'z' de su altura (0 suelo, 1
# arriba). De pie y combada hacia delante: el medio va por delante y es lo mas alto.
